    ...
    <div className="flex flex-col gap-4 bg-zinc-950 p-4 shadow-md shadow-zinc-600 rounded-lg">
      ...
      <div className="flex flex-col gap-4">
        ...
        <span>
          ...
          quisquam quia laboriosam eveniet id et! Odio, doloremque officiis?
          Aspernatur porro nobis sapiente asperiores quam animi repudiandae
          voluptate consequuntur dolore.
        </span>
      </div>
      {/* Footer POST */}
